...
#PBS -N FS_GWAS_UKB
#PBS -A UQ-IMB-CNSG
#PBS -o /shares/compbio/Group-Yang/a.xue/proj/addiction/FS/stdout_gwas_FS
#PBS -e /shares/compbio/Group-Yang/a.xue/proj/addiction/FS/stderr_gwas_FS
...
cd /shares/compbio/Group-Yang/a.xue/proj/addiction/FS/
mv *.* std* /shares/compbio/Group-Yang/a.xue/trash/

bolt="/shares/compbio/Group-Yang/a.xue/bin/BOLT-LMM_v2.3.2/bolt"
phen="/shares/compbio/Group-Yang/a.xue/proj/addiction/Former_smoking.phen"
...
out="/shares/compbio/Group-Yang/a.xue/proj/addiction/FS/ukbEUR_MAF1e-4_FS.bolt"

$bolt --bed=$bed --bim=$bim --fam=$fam --exclude $exsnp --phenoFile=$phen --phenoCol=FS --covarFile $covar --covarCol=Sex --qCovarCol=Age --qCovarCol=PC{1:10} --lmm --modelSnps=$j_hm3 --maxModelSnps=720000 --LDscoresFile=$table --geneticMapFile=$map --statsFile=$out --numThreads 16 >> FS_bolt.log 2>&1
