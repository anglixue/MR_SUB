...
#PBS -N TI_GWAS_UKB
#PBS -A UQ-IMB-CNSG
#PBS -o /shares/compbio/Group-Yang/a.xue/proj/addiction/TI/stdout_gwas_TI
#PBS -e /shares/compbio/Group-Yang/a.xue/proj/addiction/TI/stderr_gwas_TI
...
cd /shares/compbio/Group-Yang/a.xue/proj/addiction/TI/
...
out="/shares/compbio/Group-Yang/a.xue/proj/addiction/TI/ukbEUR_MAF1e-4_TI.bolt"

$bolt --bed=$bed --bim=$bim --fam=$fam --exclude $exsnp --phenoFile=$phen --phenoCol=TI --covarFile $covar --qCovarCol=PC{1:10} --lmm --modelSnps=$j_hm3 --maxModelSnps=720000 --LDscoresFile=$table --geneticMapFile=$map --statsFile=$out --numThreads 16 >> TI_bolt.log 2>&1
