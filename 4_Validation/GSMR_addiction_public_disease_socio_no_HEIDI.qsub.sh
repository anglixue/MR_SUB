#PBS -S /bin/bash
#PBS -N gsmr_addiction_public_disease_socio_no_HEIDI
#PBS -A UQ-IMB-CNSG
#PBS -o /shares/compbio/Group-Yang/a.xue/proj/addiction/GSMR/new_global_HEIDI/stdout_gsmr_addiction_public_disease_socio_no_HEIDI
#PBS -e /shares/compbio/Group-Yang/a.xue/proj/addiction/GSMR/new_global_HEIDI/stderr_gsmr_addiction_public_disease_socio_no_HEIDI
...
output_path="addiction_public_disease_socio_no_HEIDI"
